...
import math
# δημιουργούμε και γεμιζουμε τον πινακα p_xy
...
h_xy = - p_xy[0][0] * math.log(p_xy[0][0], 2.0) - p_xy[2][0] * math.log(p_xy[2][0], 2.0) - p_xy[0][1] * math.log(p_xy[0][1], 2.0) - p_xy[1][1] * math.log(p_xy[1][1], 2.0)  - p_xy[0][2] * math.log(p_xy[0][2], 2.0) - p_xy[1][2] * math.log(p_xy[1][2], 2.0)
print(h_xy)
